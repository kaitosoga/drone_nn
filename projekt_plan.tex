...
\title{\vspace{-3em}\textbf{AI Drone Race}}
...
\setlength{\parskip}{0em}
  ...
  \item ``My PID'': Das interface, um den eigenen Algorithmus zusammenzustellen.
\end{itemize}
\vspace{-1em}
\noindent
